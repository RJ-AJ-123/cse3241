-- =====================================
-- project.sqlite schema setup
-- Includes CREATE TABLE + INDEX (no INSERTs)
-- =====================================
...
CREATE INDEX idx_purchasedetails_purchaseid ON PurchaseDetailReferences(PurchaseID);
CREATE INDEX idx_purchasedetails_isbn ON PurchaseDetailReferences(ISBN);
